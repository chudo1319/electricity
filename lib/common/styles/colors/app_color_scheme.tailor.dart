...
mixin _$AppColorSchemeTailorMixin on ThemeExtension<AppColorScheme> {
  ...
  Color get onBackgroundSecondary;
  Color get danger;
  Color get onDanger;
  Color get textField;
  Color get textFieldLabel;
  Color get textFieldHelper;
  Color get frameTextFieldSecondary;
  Color get inactive;
  Color get onInactive;
  Color get positive;
  Color get onPositive;
  Color get skeletonPrimary;
  Color get onSkeletonPrimary;
  Color get shimmer;
  Color get shadow;
  ...
  AppColorScheme copyWith({
    ...
    return AppColorScheme(
      ...
      onSkeletonPrimary: onSkeletonPrimary ?? this.onSkeletonPrimary,
  ...
  AppColorScheme lerp(
    ...
    return AppColorScheme(
      ...
      onSkeletonPrimary:
          Color.lerp(onSkeletonPrimary, other.onSkeletonPrimary, t)!,
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            ...
            const DeepCollectionEquality().equals(
              textFieldLabel,
              other.textFieldLabel,
            ) &&
            const DeepCollectionEquality().equals(
              textFieldHelper,
              other.textFieldHelper,
            ) &&
            const DeepCollectionEquality().equals(
              frameTextFieldSecondary,
              other.frameTextFieldSecondary,
            ...
            const DeepCollectionEquality().equals(
              skeletonPrimary,
              other.skeletonPrimary,
            ) &&
            const DeepCollectionEquality().equals(
              onSkeletonPrimary,
              other.onSkeletonPrimary,
            ) &&
  ...
  int get hashCode {
    return Object.hashAll([
      ...
      const DeepCollectionEquality().hash(surfaceHigh),
      ...
      const DeepCollectionEquality().hash(onBackgroundSecondary),
      ...
      const DeepCollectionEquality().hash(textFieldHelper),
      const DeepCollectionEquality().hash(frameTextFieldSecondary),
      const DeepCollectionEquality().hash(inactive),
      const DeepCollectionEquality().hash(onInactive),
      const DeepCollectionEquality().hash(positive),
      const DeepCollectionEquality().hash(onPositive),
      const DeepCollectionEquality().hash(skeletonPrimary),
      const DeepCollectionEquality().hash(onSkeletonPrimary),
